...
<body>
    ...
    <div class="container py-5">
        <div>
            <a href="#" class="btn bg-custom-gradient">Create new</a>
        </div>
        <br>
        <table class="table align-middle rounded table-hover table-striped">
            ...
            <tbody>
                <tr class="">
                    <td>1</td>
                    <td>22 / 10 / 2020</td>
                    <td>Just a simple blog title</td>
                    <td class="d-flex flex-row justify-content-between manage-links">
                        ...
                        <div class="font-weight-bold text-success"><i class="fas fa-upload"></i>&emsp;Publish</div>
                        <div class="font-weight-bold text-primary"><i class="fas fa-lock"></i>&emsp;Lock</div>
